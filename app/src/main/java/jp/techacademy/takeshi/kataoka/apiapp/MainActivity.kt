...
class MainActivity : AppCompatActivity(), FragmentCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPager2.apply {
            ...
            orientation = ViewPager2.ORIENTATION_HORIZONTAL // スワイプの向き横（ORIENTATION_VERTICAL を実装すれば縦スワイプで実装可能）
            offscreenPageLimit = viewPagerAdapter.itemCount // ViewPager2で保持する画面数
        }

        // TabLayoutの初期化
        // TabLayoutとViewPager2を紐付ける
        // TabLayoutのTextを指定する
    ...
    override fun onDeleteFavorite(id: String) { // Favoriteに追加するときのメソッド（Fragment -> Activity へ通知する）
